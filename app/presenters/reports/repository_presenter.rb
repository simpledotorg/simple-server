  ...
  class RepositoryPresenter < SimpleDelegator
    ...
    def to_hash(region)
      slug = region.slug
      {
        ...
        bs_200_to_300_breakdown: diabetes_treatment_outcome_breakdown(:bs_200_to_300)[slug],
        bs_200_to_300_breakdown_counts: diabetes_treatment_outcome_breakdown_counts(:bs_200_to_300)[slug],
        bs_over_300_breakdown: diabetes_treatment_outcome_breakdown(:bs_over_300)[slug],
