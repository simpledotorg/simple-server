  ...
  class RepositoryPresenter < SimpleDelegator
    ...
    def to_hash(region)
      slug = region.slug
      {
        ...
        bs_200_to_300_patients: Flipper.enabled?(:use_who_standard_for_diabetes_indicator) ? bs_200_to_300_patients_fasting_and_hba1c[slug] : bs_200_to_300_patients[slug],
        bs_200_to_300_rates: Flipper.enabled?(:use_who_standard_for_diabetes_indicator) ? bs_200_to_300_rates_fasting_and_hba1c[slug] : bs_200_to_300_rates[slug],
        bs_200_to_300_with_ltfu_rates: Flipper.enabled?(:use_who_standard_for_diabetes_indicator) ? bs_200_to_300_rates_fasting_and_hba1c(with_ltfu: true)[slug] : bs_200_to_300_rates(with_ltfu: true)[slug],
