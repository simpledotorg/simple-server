  ...
  class RepositoryPresenter < SimpleDelegator
    ...
    def to_hash(region)
      slug = region.slug
      {
        ...
        overdue_patients_called: overdue_patients_called[slug],
        overdue_patients_called_rates: overdue_patients_called_rates[slug],
        contactable_overdue_patients_called: contactable_overdue_patients_called[slug],
        contactable_overdue_patients_called_rates: contactable_overdue_patients_called_rates[slug],
