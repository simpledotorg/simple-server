class AppointmentNotification::Worker
  ...
  def scheduled?(notification)
    ...
    Metrics.instance.increment("notifications_skipped", {reason: "not_scheduled"})
  end

  def flipper_enabled?
    Metrics.instance.increment("notifications_attempts")
    ...
    Metrics.instance.increment("notifications_skipped", {reason: "feature_disabled"})
    false
  end
end
