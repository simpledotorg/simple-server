class ProgressTab::Diabetes::BloodSugar200To299Component < ApplicationComponent
  ...
  def uncontrolled_threshold_long
    t("bs_over_200_copy.bs_200_to_299.numerator#{uncontrolled_threshold_key}")
  end

  def uncontrolled_threshold_title
    t("bs_over_200_copy.reports_card_title#{uncontrolled_threshold_key}")
  end

  def uncontrolled_threshold_short
    t("bs_over_200_copy.bs_200_to_299.title_dm#{uncontrolled_threshold_key}")
  end

  def uncontrolled_bar
    t("bs_over_200_copy.bs_200_to_299.report_card_lower_bar#{uncontrolled_threshold_key}")
  end

  def subtitle_text
    t("bs_over_200_copy.bs_200_to_299.reports_card_subtitle#{uncontrolled_threshold_key}", region_name: @region.name, diagnosis: "Diabetes", controlled_threshold: uncontrolled_threshold_long)
  end
