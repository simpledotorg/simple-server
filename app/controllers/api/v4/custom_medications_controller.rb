class Api::V4::CustomMedicationsController < Api::V4::SyncController
  ...
  def sync_to_user
    __sync_to_user__("custom_medications")
  end
  ...
  def transform_to_response(custom_medication)
    Api::V4::Transformer
      .to_response(custom_medication)
  end
