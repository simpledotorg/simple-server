module Api::V1::PatientTransformer

  def self.from_nested_request(payload_attributes)
    ...
    address_attributes       = Api::V1::Transformer.from_request(address) if address.present?
    phone_numbers_attributes = phone_numbers.map { |phone_number| Api::V1::Transformer.from_request(phone_number) } if phone_numbers.present?
    patient_attributes       = Api::V1::Transformer.from_request(payload_attributes)
