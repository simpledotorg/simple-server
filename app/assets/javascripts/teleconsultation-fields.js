...
function $MORows() {
    // Div containing Medical Officer Phone numbers
...
function addPhoneNumberFields() {
    ...
    clone.id = "mo_row_" + msec

    isd_field.id = "facility[teleconsultation_phone_numbers_attributes][" + msec + "][isd_code]"
    isd_field.name = "facility[teleconsultation_phone_numbers_attributes][" + msec + "][isd_code]"
    isd_field.removeAttribute('disabled')

    phone_number_field.id = "facility[teleconsultation_phone_numbers_attributes]["+ msec + "][phone_number]"
    phone_number_field.name = "facility[teleconsultation_phone_numbers_attributes][" + msec + "][phone_number]"
    phone_number_field.removeAttribute('disabled')
    phone_number_field.value = ''

    delete_field.id = "facility[teleconsultation_phone_numbers_attributes][" + msec + "][_destroy]"
    delete_field.name = "facility[teleconsultation_phone_numbers_attributes][" + msec + "][_destroy]"
    delete_field.setAttribute('value', "false")


    button.removeAttribute('disabled')

    $MORows().appendChild(clone)
}
