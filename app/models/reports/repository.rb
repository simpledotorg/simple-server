module Reports
  class Repository
    ...
    def controlled_patients_info
      ...
      keys = combinations.map { |region_key, period_key| [region_key, period_key, "controlled_patients_info"].join("/") }
    ...
    def controlled_patients_count_for(key)
      ...
      bp_monthly_query = LatestBloodPressuresPerPatientPerMonth
        .with_discarded
        .for_reports(with_exclusions: true)
      ...
      LatestBloodPressuresPerPatientPerMonth.with_discarded.from(bp_monthly_query, "latest_blood_pressures_per_patient_per_months")
        .under_control
        .count
    end
  end
