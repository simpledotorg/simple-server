class Api::Current::PatientTransformer
  class << self
    def from_nested_request(payload_attributes)
      ...
      business_identifiers_attributes = business_identifiers.map { |business_identifier| Api::Current::PatientBusinessIdentifierTransformer.from_request(business_identifier) } if business_identifiers.present?
