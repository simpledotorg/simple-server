  ...
  def row_data(block)
    {
      ...
      "% Diabetes missed Visits" => percentage_string(repo.diabetes_missed_visits_rates[block.slug][report_month]), # "% Missed Visits",
      ...
      **last_6_months_data(repo.cumulative_diabetes_registrations, block, :cumulative_diabetes_registrations),
      **last_6_months_data(repo.diabetes_under_care, block, :diabetes_under_care),
      **last_6_months_data(repo.monthly_diabetes_registrations, block, :monthly_diabetes_registrations),
      **last_6_months_data(repo.diabetes_follow_ups, block, :diabetes_follow_ups),
