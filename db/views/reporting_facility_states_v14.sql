WITH
    ...
    adjusted_diabetes_outcomes AS (
        SELECT assigned_facility_region_id AS region_id, month_date,
               ...
               COUNT(distinct(patient_id)) FILTER (WHERE htn_care_state = 'under_care' AND htn_treatment_outcome_in_last_3_months = 'controlled' AND systolic IS NOT NULL AND diastolic IS NOT NULL AND systolic < 130 AND diastolic < 80) AS dm_bp_below_130_80_under_care
