SELECT p.recorded_at,
       CONCAT(date_part('year', p.recorded_at), ' Q', EXTRACT(QUARTER
                                                              FROM p.recorded_at))                                    AS registration_quarter,
       p.full_name,
       (CASE
       ...
       CONCAT(date_part('year', latest_blood_pressure.recorded_at), ' Q', EXTRACT(QUARTER
                                                                                  FROM
                                                                                  latest_blood_pressure.recorded_at)) AS latest_blood_pressure_quarter,
       ...
       CONCAT(date_part('year', latest_blood_sugar.recorded_at), ' Q', EXTRACT(QUARTER
                                                                               FROM
                                                                               latest_blood_sugar.recorded_at))       AS latest_blood_sugar_quarter,
