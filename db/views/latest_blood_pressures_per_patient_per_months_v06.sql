SELECT DISTINCT ON (patient_id, year, month)
    ...
    blood_pressures.recorded_at at time zone 'utc' AS bp_recorded_at,
    patients.recorded_at at time zone 'utc' AS patient_recorded_at,
    blood_pressures.systolic AS systolic,
    blood_pressures.diastolic AS diastolic,
    blood_pressures.deleted_at at time zone 'utc' AS deleted_at,
