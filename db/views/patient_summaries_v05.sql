...
INNER JOIN regions reg_facility_region ON reg_facility_region.source_id = reg_facility.id
INNER JOIN regions reg_facility_state_region ON reg_facility_state_region.path @> reg_facility_region.path
AND reg_facility_state_region.region_type = 'state'
...
INNER JOIN regions latest_blood_pressure_facility_region ON latest_blood_pressure_facility_region.source_id = latest_blood_pressure_facility.id
INNER JOIN regions latest_blood_pressure_facility_state_region ON latest_blood_pressure_facility_state_region.path @> latest_blood_pressure_facility_state_region.path
AND latest_blood_pressure_facility_state_region.region_type = 'state'
...
INNER JOIN regions latest_blood_sugar_facility_region ON latest_blood_sugar_facility_region.source_id = latest_blood_sugar_facility.id
INNER JOIN regions latest_blood_sugar_facility_state_region ON latest_blood_sugar_facility_state_region.path @> latest_blood_sugar_facility_state_region.path
AND latest_blood_sugar_facility_state_region.region_type = 'state'
...
INNER JOIN regions next_appointment_facility_region ON next_appointment_facility_region.source_id = next_appointment_facility.id
INNER JOIN regions next_appointment_facility_state_region ON next_appointment_facility_state_region.path @> next_appointment_facility_state_region.path
AND next_appointment_facility_state_region.region_type = 'state';
