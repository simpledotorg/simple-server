class UpdateFacilityListForBdDecemberExperiment < ActiveRecord::Migration[6.1]
  def up
    ...
    Experimentation::Experiment.find_by_name("Current Patient December 2023")&.update!(filters: updated_region_filters)
    Experimentation::Experiment.find_by_name("Stale Patient December 2023")&.update!(filters: updated_region_filters)
  end
  ...
  def down
    ...
    old_region_filters = {
      "facilities" =>
        {
          "include" => %w[uhc-agailjhara uhc-babuganj-facility uhc-bakerganj uhc-hijla uhc-mehendiganj uhc-sribordi
    ...
    Experimentation::Experiment.find_by_name("Current Patient December 2023")&.update!(filters: old_region_filters)
    Experimentation::Experiment.find_by_name("Stale Patient December 2023")&.update!(filters: old_region_filters)
  end
end
