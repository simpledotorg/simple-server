...
class SetUpSmsRemindersIndiaFebApr2024 < ActiveRecord::Migration[6.1]
  # Regions where Simple is active and we send sms reminders currently:
  # States - All of West Bengal, all of Nagaland, some districts in Tamil Nadu and Maharashtra
