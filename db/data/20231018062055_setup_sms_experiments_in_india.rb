...
class SetupSmsExperimentsInIndia < ActiveRecord::Migration[6.1]
  ...
  # Simple is active in West Bengal, Nagaland, Chennai and Pune in India.
  # Below filter includes 4 states, and excludes blocks outside Pune district in Maharashtra.
  # No blocks outside Chennai district exist in database for Tamil Nadu state.
  FILTERS = {
