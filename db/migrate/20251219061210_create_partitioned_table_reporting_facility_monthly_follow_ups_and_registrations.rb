class CreatePartitionedTableReportingFacilityMonthlyFollowUpsAndRegistrations < ActiveRecord::Migration[6.1]
  def up
    execute <<~SQL
    ...
    add_index "simple_reporting.reporting_facility_monthly_follow_ups_and_registrations", ["facility_id"], name: "facility_monthly_fr_facility_id"
  ...
  def down
    drop_table "simple_reporting.reporting_facility_monthly_follow_ups_and_registrations"
  end
end
