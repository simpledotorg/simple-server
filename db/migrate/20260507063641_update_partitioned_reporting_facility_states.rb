class UpdatePartitionedReportingFacilityStates < ActiveRecord::Migration[6.1]
  def up
    execute <<~SQL
      DROP FUNCTION IF EXISTS simple_reporting.reporting_facility_states_table_function(date);
    SQL

    drop_table "simple_reporting.reporting_facility_states"
    ...
    add_index "simple_reporting.reporting_facility_states", ["block_region_id"], name: "index_fs_block"
    add_index "simple_reporting.reporting_facility_states", ["district_region_id"], name: "index_fs_district"
    add_index "simple_reporting.reporting_facility_states", ["facility_region_id"], name: "index_fs_region_id"
    add_index "simple_reporting.reporting_facility_states", ["organization_region_id"], name: "index_fs_organization"
    add_index "simple_reporting.reporting_facility_states", ["state_region_id"], name: "index_fs_state"
