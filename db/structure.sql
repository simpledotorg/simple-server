...
CREATE VIEW public.reporting_overdue_patients AS SELECT * FROM simple_reporting.reporting_overdue_patients;

--
-- Name: reporting_facility_states; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.reporting_facility_states AS SELECT * FROM simple_reporting.reporting_facility_states;
