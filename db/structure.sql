...
CREATE TABLE simple_reporting.reporting_facility_appointment_scheduled_days (
    facility_id uuid,
    month_date date,
...
CREATE FUNCTION simple_reporting.reporting_facility_appointment_scheduled_days_table_function(date) RETURNS SETOF simple_reporting.reporting_facility_appointment_scheduled_days
    LANGUAGE plpgsql
    AS $_$
BEGIN
RETURN QUERY
...
CREATE TABLE simple_reporting.reporting_facility_states (
    ...
    organization_region_id uuid,
    organization_name character varying,
    organization_slug character varying,
    cumulative_registrations bigint,
    monthly_registrations bigint,
    cumulative_diabetes_registrations bigint,
    monthly_diabetes_registrations bigint,
    cumulative_hypertension_and_diabetes_registrations bigint,
    monthly_hypertension_and_diabetes_registrations bigint,
    under_care bigint,
    lost_to_follow_up bigint,
    dead bigint,
    cumulative_assigned_patients bigint,
    diabetes_under_care bigint,
    diabetes_lost_to_follow_up bigint,
    diabetes_dead bigint,
    cumulative_assigned_diabetic_patients bigint,
    adjusted_controlled_under_care bigint,
    adjusted_uncontrolled_under_care bigint,
    adjusted_missed_visit_under_care bigint,
    adjusted_visited_no_bp_under_care bigint,
    adjusted_missed_visit_lost_to_follow_up bigint,
    adjusted_visited_no_bp_lost_to_follow_up bigint,
    adjusted_patients_under_care bigint,
    adjusted_patients_lost_to_follow_up bigint,
    adjusted_random_bs_below_200_under_care bigint,
    adjusted_fasting_bs_below_200_under_care bigint,
    adjusted_post_prandial_bs_below_200_under_care bigint,
    adjusted_hba1c_bs_below_200_under_care bigint,
    adjusted_bs_below_200_under_care bigint,
    adjusted_random_bs_200_to_300_under_care bigint,
    adjusted_fasting_bs_200_to_300_under_care bigint,
    adjusted_post_prandial_bs_200_to_300_under_care bigint,
    adjusted_hba1c_bs_200_to_300_under_care bigint,
    adjusted_bs_200_to_300_under_care bigint,
    adjusted_random_bs_over_300_under_care bigint,
    adjusted_fasting_bs_over_300_under_care bigint,
    adjusted_post_prandial_bs_over_300_under_care bigint,
    adjusted_hba1c_bs_over_300_under_care bigint,
    adjusted_bs_over_300_under_care bigint,
    adjusted_bs_missed_visit_under_care bigint,
    adjusted_visited_no_bs_under_care bigint,
    ...
    adjusted_dm_patients_40_and_above_under_care bigint,
    adjusted_dm_patients_40_and_above_with_statins bigint,
    adjusted_dm_patients_40_and_above_with_ltfu bigint,
    monthly_cohort_controlled bigint,
    monthly_cohort_uncontrolled bigint,
    monthly_cohort_missed_visit bigint,
    monthly_cohort_visited_no_bp bigint,
    monthly_cohort_patients bigint,
    monthly_overdue_calls bigint,
    monthly_follow_ups bigint,
    monthly_diabetes_follow_ups bigint,
    total_appts_scheduled integer,
    appts_scheduled_0_to_14_days integer,
    appts_scheduled_15_to_31_days integer,
    appts_scheduled_32_to_62_days integer,
    appts_scheduled_more_than_62_days integer,
    diabetes_total_appts_scheduled integer,
    diabetes_appts_scheduled_0_to_14_days integer,
    diabetes_appts_scheduled_15_to_31_days integer,
    diabetes_appts_scheduled_32_to_62_days integer,
    diabetes_appts_scheduled_more_than_62_days integer,
    overdue_patients bigint,
    contactable_overdue_patients bigint,
    patients_called bigint,
    contactable_patients_called bigint,
    patients_called_with_result_agreed_to_visit bigint,
    patients_called_with_result_remind_to_call_later bigint,
    patients_called_with_result_removed_from_list bigint,
    contactable_patients_called_with_result_agreed_to_visit bigint,
    contactable_patients_called_with_result_remind_to_call_later bigint,
    contactable_patients_called_with_result_removed_from_list bigint,
    patients_returned_after_call bigint,
    contactable_patients_returned_after_call bigint,
    patients_returned_with_result_agreed_to_visit bigint,
    patients_returned_with_result_remind_to_call_later bigint,
    patients_returned_with_result_removed_from_list bigint,
    contactable_patients_returned_with_result_agreed_to_visit bigint,
    contactable_patients_returned_with_result_remind_to_call_later bigint,
    contactable_patients_returned_with_result_removed_from_list bigint
)
PARTITION BY LIST (month_date);
...
RETURN QUERY
  ...
  dm_statins_outcomes AS (
    ...
    statin_prescriptions_by_month AS (
      SELECT DISTINCT ON (pd.patient_id, cal.month_date)
        pd.patient_id,
        cal.month_date,
...
CREATE TABLE simple_reporting.reporting_overdue_patients (
    month_date date,
    patient_id uuid,
    hypertension text,
    diabetes text,
...
CREATE FUNCTION simple_reporting.reporting_overdue_patients_table_function(date) RETURNS SETOF simple_reporting.reporting_overdue_patients
    LANGUAGE plpgsql
    AS $_$
BEGIN
RETURN QUERY
...
CREATE VIEW public.reporting_facility_appointment_scheduled_days AS
 SELECT reporting_facility_appointment_scheduled_days.facility_id,
    reporting_facility_appointment_scheduled_days.month_date,
    reporting_facility_appointment_scheduled_days.htn_appts_scheduled_0_to_14_days,
    reporting_facility_appointment_scheduled_days.htn_appts_scheduled_15_to_31_days,
    reporting_facility_appointment_scheduled_days.htn_appts_scheduled_32_to_62_days,
    reporting_facility_appointment_scheduled_days.htn_appts_scheduled_more_than_62_days,
    reporting_facility_appointment_scheduled_days.htn_total_appts_scheduled,
   ...
   FROM simple_reporting.reporting_facility_appointment_scheduled_days;
...
--
-- Name: reporting_facility_states; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.reporting_facility_states AS
 SELECT reporting_facility_states.month_date,
    reporting_facility_states.month,
    reporting_facility_states.quarter,
    reporting_facility_states.year,
    reporting_facility_states.month_string,
    reporting_facility_states.quarter_string,
    reporting_facility_states.facility_id,
    reporting_facility_states.facility_name,
    reporting_facility_states.facility_type,
    reporting_facility_states.facility_size,
    reporting_facility_states.facility_region_id,
    reporting_facility_states.facility_region_name,
    reporting_facility_states.facility_region_slug,
    reporting_facility_states.block_region_id,
    reporting_facility_states.block_name,
    reporting_facility_states.block_slug,
    reporting_facility_states.district_id,
    reporting_facility_states.district_region_id,
    reporting_facility_states.district_name,
    reporting_facility_states.district_slug,
    reporting_facility_states.state_region_id,
    reporting_facility_states.state_name,
    reporting_facility_states.state_slug,
    reporting_facility_states.organization_id,
    reporting_facility_states.organization_region_id,
    reporting_facility_states.organization_name,
    reporting_facility_states.organization_slug,
    reporting_facility_states.cumulative_registrations,
    reporting_facility_states.monthly_registrations,
    reporting_facility_states.cumulative_diabetes_registrations,
    reporting_facility_states.monthly_diabetes_registrations,
    reporting_facility_states.cumulative_hypertension_and_diabetes_registrations,
    reporting_facility_states.monthly_hypertension_and_diabetes_registrations,
    reporting_facility_states.under_care,
    reporting_facility_states.lost_to_follow_up,
    reporting_facility_states.dead,
    reporting_facility_states.cumulative_assigned_patients,
    reporting_facility_states.diabetes_under_care,
    reporting_facility_states.diabetes_lost_to_follow_up,
    reporting_facility_states.diabetes_dead,
    reporting_facility_states.cumulative_assigned_diabetic_patients,
    reporting_facility_states.adjusted_controlled_under_care,
    reporting_facility_states.adjusted_uncontrolled_under_care,
    reporting_facility_states.adjusted_missed_visit_under_care,
    reporting_facility_states.adjusted_visited_no_bp_under_care,
    reporting_facility_states.adjusted_missed_visit_lost_to_follow_up,
    reporting_facility_states.adjusted_visited_no_bp_lost_to_follow_up,
    reporting_facility_states.adjusted_patients_under_care,
    reporting_facility_states.adjusted_patients_lost_to_follow_up,
    reporting_facility_states.adjusted_random_bs_below_200_under_care,
    reporting_facility_states.adjusted_fasting_bs_below_200_under_care,
    reporting_facility_states.adjusted_post_prandial_bs_below_200_under_care,
    reporting_facility_states.adjusted_hba1c_bs_below_200_under_care,
    reporting_facility_states.adjusted_bs_below_200_under_care,
    reporting_facility_states.adjusted_random_bs_200_to_300_under_care,
    reporting_facility_states.adjusted_fasting_bs_200_to_300_under_care,
    reporting_facility_states.adjusted_post_prandial_bs_200_to_300_under_care,
    reporting_facility_states.adjusted_hba1c_bs_200_to_300_under_care,
    reporting_facility_states.adjusted_bs_200_to_300_under_care,
    reporting_facility_states.adjusted_random_bs_over_300_under_care,
    reporting_facility_states.adjusted_fasting_bs_over_300_under_care,
    reporting_facility_states.adjusted_post_prandial_bs_over_300_under_care,
    reporting_facility_states.adjusted_hba1c_bs_over_300_under_care,
    reporting_facility_states.adjusted_bs_over_300_under_care,
    reporting_facility_states.adjusted_bs_missed_visit_under_care,
    reporting_facility_states.adjusted_visited_no_bs_under_care,
    reporting_facility_states.adjusted_bs_missed_visit_lost_to_follow_up,
    reporting_facility_states.adjusted_diabetes_patients_under_care,
    reporting_facility_states.adjusted_diabetes_patients_lost_to_follow_up,
    reporting_facility_states.adjusted_dm_bp_below_140_90_under_care,
    reporting_facility_states.adjusted_dm_bp_below_130_80_under_care,
    reporting_facility_states.adjusted_dm_patients_40_and_above_under_care,
    reporting_facility_states.adjusted_dm_patients_40_and_above_with_statins,
    reporting_facility_states.adjusted_dm_patients_40_and_above_with_ltfu,
    reporting_facility_states.monthly_cohort_controlled,
    reporting_facility_states.monthly_cohort_uncontrolled,
    reporting_facility_states.monthly_cohort_missed_visit,
    reporting_facility_states.monthly_cohort_visited_no_bp,
    reporting_facility_states.monthly_cohort_patients,
    reporting_facility_states.monthly_overdue_calls,
    reporting_facility_states.monthly_follow_ups,
    reporting_facility_states.monthly_diabetes_follow_ups,
    reporting_facility_states.total_appts_scheduled,
    reporting_facility_states.appts_scheduled_0_to_14_days,
    reporting_facility_states.appts_scheduled_15_to_31_days,
    reporting_facility_states.appts_scheduled_32_to_62_days,
    reporting_facility_states.appts_scheduled_more_than_62_days,
    reporting_facility_states.diabetes_total_appts_scheduled,
    reporting_facility_states.diabetes_appts_scheduled_0_to_14_days,
    reporting_facility_states.diabetes_appts_scheduled_15_to_31_days,
    reporting_facility_states.diabetes_appts_scheduled_32_to_62_days,
    reporting_facility_states.diabetes_appts_scheduled_more_than_62_days,
    reporting_facility_states.overdue_patients,
    reporting_facility_states.contactable_overdue_patients,
    reporting_facility_states.patients_called,
    reporting_facility_states.contactable_patients_called,
    reporting_facility_states.patients_called_with_result_agreed_to_visit,
    reporting_facility_states.patients_called_with_result_remind_to_call_later,
    reporting_facility_states.patients_called_with_result_removed_from_list,
    reporting_facility_states.contactable_patients_called_with_result_agreed_to_visit,
    reporting_facility_states.contactable_patients_called_with_result_remind_to_call_later,
    reporting_facility_states.contactable_patients_called_with_result_removed_from_list,
    reporting_facility_states.patients_returned_after_call,
    reporting_facility_states.contactable_patients_returned_after_call,
    reporting_facility_states.patients_returned_with_result_agreed_to_visit,
    reporting_facility_states.patients_returned_with_result_remind_to_call_later,
    reporting_facility_states.patients_returned_with_result_removed_from_list,
    reporting_facility_states.contactable_patients_returned_with_result_agreed_to_visit,
    reporting_facility_states.contactable_patients_returned_with_result_remind_to_call_later,
    reporting_facility_states.contactable_patients_returned_with_result_removed_from_list
   FROM simple_reporting.reporting_facility_states;


--
-- Name: VIEW reporting_facility_states; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.reporting_facility_states IS 'Monthly summary of a facility''s indicators. This table has one row per facility, per month, from the month of the facility''s first registration.';
...
--
-- Name: reporting_overdue_patients; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.reporting_overdue_patients AS
 SELECT reporting_overdue_patients.month_date,
    reporting_overdue_patients.patient_id,
    reporting_overdue_patients.hypertension,
    reporting_overdue_patients.diabetes,
    reporting_overdue_patients.htn_care_state,
    reporting_overdue_patients.month,
    reporting_overdue_patients.quarter,
    reporting_overdue_patients.year,
    reporting_overdue_patients.month_string,
    reporting_overdue_patients.quarter_string,
    reporting_overdue_patients.assigned_facility_id,
    reporting_overdue_patients.assigned_facility_slug,
    reporting_overdue_patients.assigned_facility_region_id,
    reporting_overdue_patients.assigned_block_slug,
    reporting_overdue_patients.assigned_block_region_id,
    reporting_overdue_patients.assigned_district_slug,
    reporting_overdue_patients.assigned_district_region_id,
    reporting_overdue_patients.assigned_state_slug,
    reporting_overdue_patients.assigned_state_region_id,
    reporting_overdue_patients.assigned_organization_slug,
    reporting_overdue_patients.assigned_organization_region_id,
    reporting_overdue_patients.previous_appointment_id,
    reporting_overdue_patients.previous_appointment_date,
    reporting_overdue_patients.previous_appointment_schedule_date,
    reporting_overdue_patients.visited_at_after_appointment,
    reporting_overdue_patients.called_by_user_id,
    reporting_overdue_patients.next_called_at,
    reporting_overdue_patients.previous_called_at,
    reporting_overdue_patients.next_call_result_type,
    reporting_overdue_patients.next_call_removed_from_overdue_list_reason,
    reporting_overdue_patients.previous_call_result_type,
    reporting_overdue_patients.previous_call_removed_from_overdue_list_reason,
    reporting_overdue_patients.is_overdue,
    reporting_overdue_patients.has_called,
    reporting_overdue_patients.has_visited_following_call,
    reporting_overdue_patients.ltfu,
    reporting_overdue_patients.under_care,
    reporting_overdue_patients.has_phone,
    reporting_overdue_patients.removed_from_overdue_list,
    reporting_overdue_patients.removed_from_overdue_list_during_the_month
   FROM simple_reporting.reporting_overdue_patients;
...
CREATE VIEW public.reporting_patient_prescriptions AS
 SELECT reporting_patient_prescriptions.patient_id,
    ...
    reporting_patient_prescriptions.latest_cvd_risk_score_upper_range
...
--
-- Name: COLUMN reporting_patient_states.diagnosed_confirmed_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.reporting_patient_states.diagnosed_confirmed_at IS 'Time (in UTC) at which the patient had it''s first diagnosis completed, also differentiating him from screened patients.';
...
--
-- Name: index_patient_scores_on_patient_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_patient_scores_on_patient_id ON public.patient_scores USING btree (patient_id);
...
CREATE UNIQUE INDEX index_patient_scores_on_patient_id_and_score_type ON public.patient_scores USING btree (patient_id, score_type);
...
CREATE INDEX idx_rpp_latest_cvd_score_lower_range ON ONLY simple_reporting.reporting_patient_prescriptions USING btree (latest_cvd_risk_score_lower_range);
...
CREATE INDEX idx_rpp_latest_cvd_score_upper_range ON ONLY simple_reporting.reporting_patient_prescriptions USING btree (latest_cvd_risk_score_upper_range);
...
CREATE INDEX idx_rpp_month_patient ON ONLY simple_reporting.reporting_patient_prescriptions USING btree (month_date, patient_id);
...
CREATE INDEX index_reporting_facility_appointment_scheduled_days_facility_id ON ONLY simple_reporting.reporting_facility_appointment_scheduled_days USING btree (facility_id);
...
CREATE INDEX overdue_patients_assigned_facility_region_id ON ONLY simple_reporting.reporting_overdue_patients USING btree (assigned_facility_region_id);
...
CREATE INDEX overdue_patients_patient_id ON ONLY simple_reporting.reporting_overdue_patients USING btree (patient_id);
...
--
-- Name: patient_scores fk_rails_184b6206f2; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.patient_scores
    ADD CONSTRAINT fk_rails_184b6206f2 FOREIGN KEY (patient_id) REFERENCES public.patients(id);
