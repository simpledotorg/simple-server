  ...
  task :export, [:file_path] => :environment do |_task, args|
    ...
    patients.each do |patient|
      ...
      patient.appointments.each do |appointment|
        ...
        resources << OneOff::Opensrp::AppointmentExporter.new(appointment).export
        encounters << OneOff::Opensrp::AppointmentExporter.new(appointment).export_encounter
      end
      resources << OneOff::Opensrp::EncounterDeduplicator.new(encounters).export_deduplicated
    end
