class GetBsnlTemplateDetails
  ...
  def write_config_to_tmp_file
    ...
    config = template_details.to_h do |template|
      [
        ...
        template.slice("Template_Id", "Template_Keys", "Non_Variable_Text_Length", "Max_Length_Permitted")
      ]
    end

    File.open(config_output, "w") do |file|
      file.write("# This is an autogenerated file. Do not modify.\n")
      file.write("# Use get_bsnl_template_details.rake to fetch a new copy of this file.\n")
  ...
  def validate_statuses
    ...
    if templates_pending_naming.any?
      error "⚠️  These templates haven't been named on BSNL dashboard:"
