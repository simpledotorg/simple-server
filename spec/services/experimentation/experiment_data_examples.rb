RSpec.shared_context "active experiment data", :shared_context => :metadata do
  ...
  before do
    ...
    _control_followup_1 = create(:blood_pressure, patient: @control_patient, device_created_at: 28.days.ago)
    @control_appt2 = create(:appointment, patient: @control_patient, scheduled_date: 20.days.ago, device_created_at: 40.days.ago)
    _control_followup_2 = create(:blood_sugar, patient: @control_patient, device_created_at: 21.days.ago)
    @control_past_visit_1 = create(:blood_pressure, patient: @control_patient, device_created_at: 8.months.ago)
    @control_past_visit_2 = create(:blood_pressure, patient: @control_patient, device_created_at: 3.months.ago)
    ...
    _smp_followup_pd = create(:prescription_drug, patient: @single_message_patient, device_created_at: 21.days.ago)
