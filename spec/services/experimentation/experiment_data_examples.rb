RSpec.shared_context "active experiment data", :shared_context => :metadata do
  ...
  before do
    ...
    @control_appt_1 = create(:appointment, patient: @control_patient, scheduled_date: first_week_of_experiment, device_created_at: week_before_experiment)
    @control_followup_1 = create(:blood_pressure, patient: @control_patient, device_created_at: first_week_of_experiment + 2.days)
    @control_appt_2 = create(:appointment, patient: @control_patient, scheduled_date: second_week_of_experiment, device_created_at: week_before_experiment)
    ...
    @smp_appt = create(:appointment, patient: @single_message_patient, scheduled_date: second_week_of_experiment)
