...
RSpec.describe PatientBreakdownService do
  ...
  describe ".call" do
    it "gets the patient breakdowns by status and ltfu-ness and caches it" do
      ...
      _reassigned_hypertensive_patient = create(
        :patient,
        :hypertension,
      ...
      _not_diabetes_patient = create(:patient, :without_diabetes, assigned_facility: facility)
      _reassigned_diabetes_patient = create(
        :patient,
        :diabetes,
        assigned_facility: another_facility,
        registration_facility: facility
