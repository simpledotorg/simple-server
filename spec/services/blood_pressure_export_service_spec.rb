  ...
  describe "#call" do
    context "when data is downloaded" do
      it "formats as expected" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(Date.new(2020, 12, 1), Date.new(2021, 5, 1)))
        refresh_views
