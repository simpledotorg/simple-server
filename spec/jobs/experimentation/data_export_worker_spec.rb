  ...
  describe "#perform" do
    ...
    it "formats the email and attachment correctly" do
      ...
      expected_file_contents =
        %(Experiment Name,Treatment Group,Experiment Inclusion Date,Appointment 1 Creation Date,Appointment 1 Date,\
...
2020-01-01,#{@cascade_patient.treatment_group_memberships.last.id}\n)
      ...
      expect(mailer).to receive(:mail).with(email_params)
