...
RSpec.describe Upcoming::Read::OrganizationPolicy::Scope do
  ...
  context "user can manage all organizations" do
    ...
    it "resolve all organizations" do
      ...
      expect(resolved_records).to include(organization_1, organization_2)
    end
  end
  ...
  context "user can manage an organization" do
    ...
    it "resolves their organization" do
      ...
      expect(resolved_records).to include(organization_1)
      expect(resolved_records).not_to include(organization_2)
    end
  end
