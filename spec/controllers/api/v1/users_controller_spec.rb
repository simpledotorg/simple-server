  ...
  describe '#register' do
    ...
    describe 'registration payload is valid' do
      ...
      it 'sends an email to a list of owners and supervisors' do
        ...
        expect(Config.get('SUPERVISOR_EMAILS')).to match(/#{Regexp.quote(approval_email.to.first)}/)
        expect(Config.get('OWNER_EMAILS')).to match(/#{Regexp.quote(approval_email.cc.first)}/)
