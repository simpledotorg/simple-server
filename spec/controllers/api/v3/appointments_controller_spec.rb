      ...
      context "region-level sync is turned on" do
        ...
        it "only sends data belonging to the patients in the block of user's facility" do
          expected_records = [
            ...
            *create_list(:appointment, 2, patient: patient_assigned_to_block, facility: facility_in_same_block),
            *create_list(:appointment, 2, patient: patient_with_appointment_in_block, facility: facility_in_same_block)
          ]
