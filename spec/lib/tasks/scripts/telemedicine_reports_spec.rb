...
RSpec.describe TelemedicineReports do
  ...
  let!(:teleconsultation_request) { create(:teleconsultation, facility: facility_1, patient: high_bps.first.patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day) }
  ...
  context ".generate_report" do
    it "generates a report file" do
      ...
      report_data = [["", "", "", "", "", "", "", "Between #{period_start.strftime("%d-%b-%Y")} and #{period_end.strftime("%d-%b-%Y")}", "", "", "", "", ""],
        ["State", "District", "Facility", "Facilities with telemedicine", "HWCs & SCs with telemedicine", "Users of telemedicine", "", "Patients who visited", "Patients with High BP", "Patients with High Blood Sugar", "Patients with High BP or Sugar", "Teleconsult Button Clicks", "Teleconsultation MVP Requests", "Teleconsultation MVP Records logged by MOs", "Teleconsultation MVP Requests marked 'completed'", "Teleconsult requests percentage"],
        [facility_1.state, "", "", 10, 1, 1, "", 2, 2, 0, 2, 10, 1, 1, 0, "550%"],
        ["", facility_1.district, "", 10, 1, 1, "", 2, 2, 0, 2, 10, 1, 1, 0, "550%"],
        [],
        [],
        ...
        [facility_1.state, "", "", 10, 1, 1, "", 2, 2, 0, 2, 10, 1, 1, 0, "550%"],
        ["", facility_1.district, "", 10, 1, 1, "", 2, 2, 0, 2, 10, 1, 1, 0, "550%"],
        ["", "", facility_1.name, "", "", 1, "", 2, 2, 0, 2, "", 1, 1, 0, ""],
        [],
        [],
        ["Date", "Unique users for old telemed system", "TC requests from old telemed system", "Unique users for Telemed MVP", "TC requests from Telemed MVP"],
        ["04-Aug-2020", 2, 6, 1, 1],
        ["06-Aug-2020", 1, 1, 0, 0],
        ["07-Aug-2020", 1, 2, 0, 0],
        ["08-Aug-2020", 1, 1, 0, 0]]
