...
RSpec.describe TelemedicineReports do
  ...
  context ".generate" do
    it "emails a report file" do
      ...
      facility_1 = create(:facility, :with_teleconsultation, facility_type: "HWC")
      facility_2 = create(:facility, :with_teleconsultation, facility_type: "DH", facility_group: facility_1.facility_group)
      ...
      _high_bps_2 =  create_list(:blood_pressure, 2, :with_encounter, :hypertensive, facility: facility_2, user: user_2, recorded_at: period_start + 1.day)
      ...
      _teleconsultation_requests_marked_complete =  patients.slice(3, 2).each { |patient| create(:teleconsultation, facility: facility_1, patient: patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day, requester_completion_status: "yes", recorded_at: nil) }
      _teleconsultation_mo_logged_record =  create(:teleconsultation, facility: facility_1, patient: patients.last, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day)
      _teleconsultation_requests_marked_waiting =  patients.slice(5, 2).each { |patient| create(:teleconsultation, facility: facility_1, patient: patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day, requester_completion_status: "waiting", recorded_at: nil) }
      _teleconsultation_requests_not_marked =  patients.slice(7, 2).each { |patient| create(:teleconsultation, facility: facility_1, patient: patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day, requester_completion_status: nil, recorded_at: nil) }
      _unmarked_requests_which_should_be_excluded_from_counts =  patients.each { |patient| create(:teleconsultation, facility: facility_1, patient: patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day, requester_completion_status: nil, recorded_at: nil) }
      _waiting_requests_which_should_be_excluded_from_counts =  patients.slice(3, 2).each { |patient| create(:teleconsultation, facility: facility_1, patient: patient, requester: user_1, requested_medical_officer: user_2, medical_officer: user_2, device_created_at: Date.parse("2020-08-04").beginning_of_day, requester_completion_status: "waiting", recorded_at: nil) }
