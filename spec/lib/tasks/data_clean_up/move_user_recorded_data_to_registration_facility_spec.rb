...
RSpec.describe MoveUserRecordedDataToRegistrationFacility do
  ...
  let(:another_wrong_facility) { create(:facility) }
  ...
  describe "#fix_patient_data" do
    ...
    let!(:patients_at_another_wrong_facility) { create_list(:patient, 2, registration_user: user, registration_facility: another_wrong_facility) }
    ...
    it "Does not move patients at a different wrong facility to the user's registration facility" do
      expect {
        service.fix_patient_data
      }.not_to change(Patient.where(registration_user: user, registration_facility: another_wrong_facility), :count)
    end
  ...
  describe "#fix_blood_pressures_data" do
    ...
    let!(:bps_at_another_wrong_facility) { create_list(:blood_pressure, 2, user: user, facility: another_wrong_facility) }
    ...
    it "Does not move blood pressures at a different wrong facility to the user's registration facility" do
      expect {
        service.fix_patient_data
      }.not_to change(BloodPressure.where(user: user, facility: another_wrong_facility), :count)
    end
  ...
  describe "#fix_appointments_data" do
    ...
    let!(:appointments_at_another_wrong_facility) { create_list(:appointment, 2, facility: another_wrong_facility) }
    ...
    it "Does not move appointments at a different wrong facility to the user's registration facility" do
      expect {
        service.fix_patient_data
      }.not_to change(Appointment.where(facility: another_wrong_facility), :count)
    end
  ...
  describe "#fix_prescription_drugs_data" do
    ...
    let!(:prescription_drugs_at_another_wrong_facility) { create_list(:prescription_drug, 2, facility: another_wrong_facility) }
    ...
    it "Does not move prescription drugs at a different wrong facility to the user's registration facility" do
      expect {
        service.fix_patient_data
      }.not_to change(PrescriptionDrug.where(facility: another_wrong_facility), :count)
    end
