...
describe Reports::RegionSummarySchema, type: :model do
  ...
  it "returns data correctly grouped when passed mixed region types" do
    ...
    Timecop.freeze(jan_2020) do
      ...
      allow(Reports::PatientState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(Date.today, Date.today + 2.years))
      allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(Date.today, Date.today + 2.years))
    end
  ...
  it "can return earliest patient recorded at" do
    Timecop.freeze(jan_2020) {
      create(:patient, assigned_facility: facility, registration_user: user)
      allow(Reports::PatientState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(Date.today, Date.today + 1.month))
      allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(Date.today, Date.today + 1.month))
    }
  ...
  describe "diabetes" do
    ...
    describe "#bs_below_200_rates" do
      it "returns the bs_below_200 rates over time for a region" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 3.months))
        refresh_views
    ...
    describe "#bs_below_200_rates_fasting_and_hba1c" do
      it "returns the bs_below_200_fasting_and_hba1c rates over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_below_200, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_below_200, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :fasting, :bs_below_200, patient: facility_1_patients.third, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        expect(schema.bs_below_200_rates_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(67)
        expect(schema.bs_below_200_rates_fasting_and_hba1c(with_ltfu: true)[facility_1.region.slug]["Mar 2020".to_period]).to eq(50)
      end
    end

    describe "#bs_200_to_300_rates_fasting_and_hba1c" do
      it "returns the bs_200_to_300_rates_fasting_and_hba1c rates over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_200_to_300, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_200_to_300, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        expect(schema.bs_200_to_300_rates_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(67)
        expect(schema.bs_200_to_300_rates_fasting_and_hba1c(with_ltfu: true)[facility_1.region.slug]["Mar 2020".to_period]).to eq(50)
      end
    end

    describe "#bs_over_300_rates_fasting_and_hba1c" do
      it "returns the bs_over_300_rates_fasting_and_hba1c rates over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_over_300, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_over_300, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        expect(schema.bs_over_300_rates_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(67)
        expect(schema.bs_over_300_rates_fasting_and_hba1c(with_ltfu: true)[facility_1.region.slug]["Mar 2020".to_period]).to eq(50)
      end
    end

    describe "#bs_below_200_patients_fasting_and_hba1c" do
      it "returns bs_below_200_patients_fasting_and_hba1c over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_below_200, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_below_200, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :fasting, :bs_below_200, patient: facility_1_patients.third, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        (("Jan 2019".to_period)..("Feb 2020".to_period)).each do |period|
          [facility_1.region, region].each do |r|
            expect(schema.bs_below_200_patients[r.slug][period]).to eq(0)
            expect(schema.bs_below_200_patients(with_ltfu: true)[r.slug][period]).to eq(0)
          end
        end
        expect(schema.bs_below_200_patients_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(2)
      end
    end

    describe "#bs_200_to_300_patients_fasting_and_hba1c" do
      it "returns bs_200_to_300_patients_fasting_and_hba1c over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_200_to_300, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_200_to_300, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :fasting, :bs_200_to_300, patient: facility_1_patients.third, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        (("Jan 2019".to_period)..("Feb 2020".to_period)).each do |period|
          [facility_1.region, region].each do |r|
            expect(schema.bs_200_to_300_patients[r.slug][period]).to eq(0)
            expect(schema.bs_200_to_300_patients(with_ltfu: true)[r.slug][period]).to eq(0)
          end
        end
        expect(schema.bs_200_to_300_patients_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(2)
      end
    end

    describe "#bs_over_300_patients_fasting_and_hba1c" do
      it "returns bs_over_300_patients_fasting_and_hba1c over time for a region" do
        facility_1_patients = create_list(:patient, 4, :diabetes, assigned_facility: facility_1, recorded_at: jan_2019)
        create(:blood_sugar, :with_encounter, :random, :bs_over_300, patient: facility_1_patients.first, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :hba1c, :bs_over_300, patient: facility_1_patients.second, facility: facility_1, recorded_at: jan_2020 + 2.months)
        create(:blood_sugar, :with_encounter, :fasting, :bs_over_300, patient: facility_1_patients.third, facility: facility_1, recorded_at: jan_2020 + 2.months)
        ...
        (("Jan 2019".to_period)..("Feb 2020".to_period)).each do |period|
          [facility_1.region, region].each do |r|
            expect(schema.bs_over_300_patients[r.slug][period]).to eq(0)
            expect(schema.bs_over_300_patients(with_ltfu: true)[r.slug][period]).to eq(0)
          end
        end
        expect(schema.bs_over_300_patients_fasting_and_hba1c[facility_1.region.slug]["Mar 2020".to_period]).to eq(2)
      end
    end
    ...
    describe "#diabetes_patients_by_risk_state_and_type" do
      context "with multiple sugar types passed" do
        it "returns the cumulative values of blood sugar types passed related to blood sugar risk type" do
          ...
          create(:blood_sugar, :with_encounter, :random, :bs_over_300, patient: facility_1_patients[0], facility: facility_1, recorded_at: jan_2020 + 2.months)
          create(:blood_sugar, :with_encounter, :hba1c, :bs_over_300, patient: facility_1_patients[1], facility: facility_1, recorded_at: jan_2020 + 2.months)
          create(:blood_sugar, :with_encounter, :fasting, :bs_over_300, patient: facility_1_patients[2], facility: facility_1, recorded_at: jan_2020 + 2.months)
          create(:blood_sugar, :with_encounter, :fasting, :bs_below_200, patient: facility_1_patients[3], facility: facility_1, recorded_at: jan_2020 + 2.months)
          create(:blood_sugar, :with_encounter, :random, :bs_below_200, patient: facility_1_patients[4], facility: facility_1, recorded_at: jan_2020 + 2.months)
    ...
    describe "#diabetes_missed_visits_rates" do
      it "returns the percentage of patients with missed visits in a region" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2019.to_date, jan_2020.to_date + 6.months))
        refresh_views
        schema = described_class.new([facility_1.region, facility_2.region, region], periods: range)
    ...
    describe "#visited_without_bs_taken_rates" do
      it "returns the percentage of patients who visited without bs taken in a region" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 6.months))
        refresh_views
        schema = described_class.new([facility_1.region, facility_2.region, region], periods: range)
    ...
    describe "diabetes_treatment_outcome_breakdown_rates" do
      before {
        allow(Reports::PatientState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 4.months))
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 4.months))
      }
    ...
    describe "#diabetes_patients_with_bs_taken" do
      it "returns the total number of patients with a blood sugar measured in the last 3 months" do
        ...
        allow(Reports::PatientState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 7.months))
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2020.to_date, jan_2020.to_date + 7.months))
        refresh_views
    ...
    describe "#dm_controlled_bp_140_90_rates" do
      it "returns the DM controlled BP < 140/90 rates over time for a region" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates((jan_2020 - 1.month).to_date, jan_2020.to_date + 3.months))
        refresh_views
    ...
    describe "#dm_prescribed_statins_rates" do
      ...
      it "returns the DM patients ≥40 prescribed statins rates over time for a region" do
        ...
        allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(may_2025.to_date, (june_2025_date + 1.month).to_date))
        refresh_views
  ...
  describe "hypertension and diabetes" do
    ...
    it "returns the number of patients registered who have both hypertension and diabetes" do
      ...
      allow(Reports::PatientState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2019.to_date, jan_2019.to_date + 4.months))
      allow(Reports::FacilityState).to receive(:get_refresh_months).and_return(ReportingHelpers.get_refresh_months_between_dates(jan_2019.to_date, jan_2019.to_date + 4.months))
      refresh_views
  ...
  describe "overdue hypertension patients" do
    ...
    describe "#contactable_patients_returned_after_call_rates" do
      it "returns the percentage of contactable overdue patients who returned to care after getting a call" do
        ...
        facility_1_contactable_patients.each { |patient| create(:appointment, patient: patient, device_created_at: three_months_ago, scheduled_date: three_months_ago + 15.days) }
        facility_1_patients_without_phone = create_list(:patient, 2, :without_phone_number, :hypertension, assigned_facility: facility_1, recorded_at: five_months_ago)
        facility_1_patients_without_phone.each { |patient| create(:appointment, patient: patient, device_created_at: three_months_ago, scheduled_date: three_months_ago + 15.days) }
        ...
        facility_2_contactable_patients.each { |patient| create(:appointment, patient: patient, device_created_at: three_months_ago, scheduled_date: three_months_ago + 15.days) }
        facility_2_patient_without_phone = create(:patient, :without_phone_number, :hypertension, assigned_facility: facility_2, recorded_at: five_months_ago)
    ...
    describe "#contactable_patients_returned_with_result_agreed_to_visit_rates" do
      it "returns the percentage of contactable overdue patients who returned to care who agreed to visit" do
        facility_1_patients = create_list(:patient, 5, :with_sanitized_phone_number, :hypertension, assigned_facility: facility_1, recorded_at: five_months_ago)
        facility_1_patients.each { |patient| create(:appointment, patient: patient, device_created_at: three_months_ago, scheduled_date: three_months_ago + 15.days) }
        create(:call_result, result_type: :agreed_to_visit, patient: facility_1_patients.first, device_created_at: this_month)
        create(:call_result, result_type: :agreed_to_visit, patient: facility_1_patients.second, device_created_at: this_month)
        create(:call_result, result_type: :agreed_to_visit, patient: facility_1_patients.third, device_created_at: this_month + 12.day)
        ...
        facility_2_patients = create_list(:patient, 3, :with_sanitized_phone_number, :hypertension, assigned_facility: facility_2, recorded_at: five_months_ago)
        facility_2_patients.each { |patient| create(:appointment, patient: patient, device_created_at: three_months_ago, scheduled_date: three_months_ago + 15.days) }
        create(:call_result, result_type: :agreed_to_visit, patient: facility_2_patients.first, device_created_at: this_month + 12.days)
        create(:call_result, result_type: :agreed_to_visit, patient: facility_2_patients.second, device_created_at: this_month + 3.days)
        create(:call_result, result_type: :agreed_to_visit, patient: facility_2_patients.third, device_created_at: one_month_ago.end_of_month.beginning_of_day)
