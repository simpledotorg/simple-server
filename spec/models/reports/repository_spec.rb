    ...
    context "follow_ups_v2 => #{follow_ups_v2}" do
      ...
      it "returns counts of follow_ups taken per region" do
        ...
        Timecop.freeze("May 10th 2021") do
          ...
          bp = create(:bp_with_encounter, recorded_at: 2.months.ago, facility: facility_1, patient: patient_2, user: user_2)
          ...
          repo_3 = described_class.new(facility_2, periods: "February 1st 2021".to_period, follow_ups_v2: follow_ups_v2)
