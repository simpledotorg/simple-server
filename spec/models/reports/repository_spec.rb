...
[true, false].each do |v2_flag|
  RSpec.describe "Reports::Repository (reporting_schema_v2=>#{v2_flag})", type: :model do
    ...
    context "earliest patient record" do
      it "returns the earliest between both assigned and registered if both exist" do
        ...
        repo = Reports::Repository.new(facility_group_1.region, periods: jan_2019.to_period, reporting_schema_v2: v2_flag)
    ...
    context "counts and rates" do
      ...
      it "gets assigned and registration counts for a range of periods" do
        ...
        repo = Reports::Repository.new(facility_1.region, periods: (july_2018.to_period..july_2020.to_period), reporting_schema_v2: true)
    ...
    context "v2" do
      it "gets registrations" do
        ...
        repo = Reports::Repository.new(regions, periods: (july_2018.to_period..july_2020.to_period), reporting_schema_v2: false)
