  ...
  describe "Timeline" do
    ...
    it "creates a correct timeline of medications the patient has been on every month" do
      with_reporting_time_zone do
        DrugLookup::MedicinePurpose.create(name: "Amlodipine", hypertension: true, diabetes: false)
        DrugLookup::MedicinePurpose.create(name: "Atenolol", hypertension: true, diabetes: false)
        DrugLookup::MedicinePurpose.create(name: "Telmisartan", hypertension: true, diabetes: false)
        ...
        DrugLookup::RawToCleanMedicine.create({raw_name: "Aten", raw_dosage: "10mg", rxcui: 555})
        DrugLookup::CleanMedicineToDosage.create({medicine: "Atenolol", dosage: 10, rxcui: 555})
        ...
        add_drug(patient, "Aten", "10mg", june_2021[:one_month_ago])
