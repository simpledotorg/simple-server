  ...
  describe "View" do
    ...
    describe ".overdue scope" do
      it "includes overdue appointments and excludes non-overdue" do
        overdue_appointment = create(:appointment, :overdue)
        upcoming_appointment = create(:appointment)
    ...
    describe "Next appointment details" do
      let(:next_appointment) { create(:appointment, patient: patient, user: user) }
