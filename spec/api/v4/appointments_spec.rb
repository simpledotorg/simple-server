...
describe "Appointment v4 API", swagger_doc: "v4/swagger.json" do
  path "/appointments/sync" do
    post "Syncs appointment data from device to server." do
      ...
      parameter name: :appointments, in: :body, schema: Api::V4::Schema.appointment_sync_from_user_request
    ...
    get "Syncs appointment data from server to device." do
      ...
      response "200", "appointments received" do
        ...
        schema Api::V4::Schema.appointment_sync_to_user_response
