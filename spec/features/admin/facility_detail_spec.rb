...
RSpec.feature 'Facility page functionality', type: :feature do
  ...
  it 'Verify facility landing page ' do
    facility_list = [ihmi_group_bathinda.name, group_gurdaspur.name]
  ...
  it 'create new facility group without assigning any facility' do
    ...
    facility_group.add_new_facility_group_without_assigning_facility('IHMI', 'testfacilitygroup', 'testDescription', protocol_01.name)
  ...
  it 'owner should be able to delete facility group without facility ' do
    ...
    facility_page.click_edit_button_present_for_facility_group("testfacilitygroup")
