...
RSpec.describe OverduePatientsQuery do
  ...
  context "count_contactable_patients_called" do
    it "should return count of contactable overdue patients called" do
      ...
      patient_1 = create(:patient, assigned_facility: facility, phone_numbers: [])
      patient_2 = create(:patient, assigned_facility: facility)
      patient_3 = create(:patient, assigned_facility: facility)
      patient_4 = create(:patient, assigned_facility: facility, phone_numbers: [])
    ...
    it "should return count of contactable overdue patients called grouped by the group_by condition" do
      facility = create(:facility)
      user_1 = create(:user, registration_facility: facility)
      user_2 = create(:user, registration_facility: facility)
      ...
      expect(described_class.new.count_contactable_patients_called(facility.region, :month,
        group_by: :called_by_user_id)).to eq(expected)
    end

    it "should not include contactable overdue patients who were not called" do
      facility = create(:facility)
      user_1 = create(:user, registration_facility: facility)
      user_2 = create(:user, registration_facility: facility)
    ...
    it "should only include contactable patients who were assigned to the facility" do
      facility_1 = create(:facility)
      facility_2 = create(:facility)
      user_1 = create(:user, registration_facility: facility_1)
      user_2 = create(:user, registration_facility: facility_2)

      patient_1 = create(:patient, assigned_facility: facility_2, phone_numbers: [])
      patient_2 = create(:patient, assigned_facility: facility_1)
      patient_3 = create(:patient, assigned_facility: facility_1)
      patient_4 = create(:patient, assigned_facility: facility_2)
      ...
      expect(described_class.new.count_contactable_patients_called(facility_2.region, :month,
        group_by: :called_by_user_id)).to eq(expected)
    end
    ...
    it "should include patients assigned to a facility regardless of which facility the user called from" do
      ...
      patient_1 = create(:patient, assigned_facility: facility_1, phone_numbers: [])
      patient_2 = create(:patient, assigned_facility: facility_1)
      patient_3 = create(:patient, assigned_facility: facility_2)
      patient_4 = create(:patient, assigned_facility: facility_2)
