  ...
  context 'hyperstension under care patients' do
    it 'returns patients registered for provided month' do
      Timecop.freeze('April 25th 2024') do
        ...
        patient_seven_months = create(:patient, :hypertension, registration_facility: regions[:facility_1], recorded_at: seven_months_ago)
        patient_five_months = create(:patient, :hypertension, registration_facility: regions[:facility_1], recorded_at: five_months_ago)
