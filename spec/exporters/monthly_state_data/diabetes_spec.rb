...
describe MonthlyStateData::Diabetes do
  ...
  let(:facility1) { create(:facility, facility_group: facility_group, enable_diabetes_management: true) }
  let(:facility2) { create(:facility, facility_group: facility_group, enable_diabetes_management: true) }
  ...
  let(:missed_visit_patient) do
    patient = create(:patient, :diabetes, recorded_at: 4.months.ago, assigned_facility: facility1, registration_facility: facility1)
