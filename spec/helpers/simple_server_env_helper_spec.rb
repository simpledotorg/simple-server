  ...
  describe "logo_for_environment" do
    ...
    context "when in the production environment" do
      it "should return the production logo" do
        ENV[simple_server_env] = "production"
        logo_for_production_environment = image_tag "logos/production/simple_logo.svg", width: 30, height: 30, class: "d-inline-block align-top", alt: "Simple Dashboard Logo"
