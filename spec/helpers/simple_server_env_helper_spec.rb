...
RSpec.describe SimpleServerEnvHelper do
  ...
  describe 'logo_for_environment' do
    context 'when in the default environment' do
      it 'should return the default logo' do
        ENV[simple_server_env] = 'default'
        logo_for_default_environment = image_tag 'default/simple_logo.svg', width: 30, height: 30, class: 'd-inline-block mr-2 align-top', alt: 'Simple Dashboard Logo'
    ...
    context 'when in the qa environment' do
      it 'should return the QA logo' do
        ENV[simple_server_env] = 'qa'
        logo_for_qa_environment = image_tag 'qa/simple_logo.svg', width: 30, height: 30, class: 'd-inline-block mr-2 align-top', alt: 'Simple Dashboard Qa Logo'
    ...
    context 'when in the staging environment' do
      it 'should return the staging logo' do
        ENV[simple_server_env] = 'staging'
        logo_for_staging_environment = image_tag 'staging/simple_logo.svg', width: 30, height: 30, class: 'd-inline-block mr-2 align-top', alt: 'Simple Dashboard Staging Logo'
    ...
    context 'when in the sandbox environment' do
      it 'should return the sandbox logo' do
        ENV[simple_server_env] = 'sandbox'
        logo_for_sandbox_environment = image_tag 'sandbox/simple_logo.svg', width: 30, height: 30, class: 'd-inline-block mr-2 align-top', alt: 'Simple Dashboard Sandbox Logo'
    ...
    context 'when in the production environment' do
      it 'should return the production logo' do
        ENV[simple_server_env] = 'production'
        logo_for_production_environment = image_tag 'production/simple_logo.svg', width: 30, height: 30, class: 'd-inline-block mr-2 align-top', alt: 'Simple Dashboard Production Logo'
  ...
  describe 'apple_logo_for_environment' do
    ...
    context 'when in the default environment' do
      let(:expected_apple_touch) { 'default/simple_logo_apple_touch.png' }
    ...
    SimpleServerEnvHelper::CUSTOMIZED_ENVS.each do |environment|
      context "when in the #{environment} environment" do
        let(:expected_apple_touch) { "#{environment}/simple_logo_apple_touch.png" }
  ...
  describe 'android_logo_for_environment' do
    ...
    context 'when in the default environment' do
      let(:expected_logo_android_192) { 'default/simple_logo_android_192.png' }
    ...
    SimpleServerEnvHelper::CUSTOMIZED_ENVS.each do |environment|
      context "when in the #{environment} environment" do
        let(:expected_logo_android_192) { "#{environment}/simple_logo_android_192.png" }
  ...
  describe 'favicon_for_environment' do
    ...
    context 'when in the default environment' do
      let(:expected_favicon) { 'default/simple_logo_favicon.png' }
    ...
    SimpleServerEnvHelper::CUSTOMIZED_ENVS.each do |environment|
      context "when in the #{environment} environment" do
        let(:expected_favicon) { "#{environment}/simple_logo_favicon.png" }
  ...
  describe 'mailer_logo_for_environment' do
    ...
    context 'when in the default environment' do
      let(:expected_logo) do
        image_tag 'default/simple_logo_256.png', width: 48, height: 48, style: 'width: 48px; height: 48px;'
      end
    ...
    SimpleServerEnvHelper::CUSTOMIZED_ENVS.each do |environment|
      context "when in the #{environment} environment" do
        let(:expected_logo) do
          image_tag "#{environment}/simple_logo_256.png", width: 48, height: 48, style: 'width: 48px; height: 48px;'
        end
