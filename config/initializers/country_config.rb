class CountryConfig
  ...
  CONFIGS = {
    IN: {
      ...
      reportable_regions: %w[state district block facility],
    ...
    BD: {
      ...
      reportable_regions: %w[district facility],
    ...
    ET: {
      abbreviation: "ET",
      name: "Ethiopia",
      reportable_regions: %w[organization state district block facility],
      extended_region_reports: true,
