...
module SimpleServer
  class Application < Rails::Application
    ...
    config.i18n.available_locales = %w[am-ET bn-BD bn-IN en en-BD en-ET en-IN en-IND en-LK es hi-IN kn-IN mr-IN om-ET pa-Guru-IN si-LK sid-ET so-ET ta-IN ta-LK te-IN ti-ET]
